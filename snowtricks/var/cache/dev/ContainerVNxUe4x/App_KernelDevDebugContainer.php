...
class App_KernelDevDebugContainer extends Container
{
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $c = new \Doctrine\ORM\Mapping\Driver\AnnotationDriver(($this->privates['annotations.cached_reader'] ?? $this->getAnnotations_CachedReaderService()), [0 => (\dirname(__DIR__, 4).'/src/Auth/Domain/Entity'), 1 => (\dirname(__DIR__, 4).'/src/Trick/Domain/Entity'), 2 => (\dirname(__DIR__, 4).'/src/Chat/Domain/Entity')]);
